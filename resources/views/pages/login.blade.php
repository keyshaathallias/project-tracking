      ...
      <div class="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
        ...
        <form method="POST" action="{{ route('login.submit') }}" class="w-full px-4">
          ...
          <div class="relative mt-3">
            ...
            <!-- Hide Password Icon -->
            <svg id="eye-closed"
              class="hidden absolute top-1/2 right-[17px] transform -translate-y-1/2 w-5 h-5 text-primary cursor-pointer"
              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="currentColor">
              <path
          ...
          <button type="submit"
            class="mt-5 w-full py-3 px-6 rounded-full font-semibold text-sm bg-gradient-to-r from-violet to-primary hover:from-primary hover:to-violet hover:shadow-lg text-white transition duration-300 ease-in-out transform focus:outline-2 focus:outline-light">Login</button>
        </form>
      </div>
    </div>
