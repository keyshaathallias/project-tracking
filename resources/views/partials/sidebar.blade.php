<aside class="relative w-80 bg-primary text-white flex-col justify-between min-h-screen overflow-hidden hidden md:block">
  ...
  <div class="relative z-10">
    ...
    <nav class="space-y-1">
      ...
      <a href="/projects"
        class="flex items-center gap-5 py-5 px-10 {{ request()->is('projects') ? 'bg-light-blue text-primary' : '' }} transition duration-200 ease-in-out hover:bg-dusty-blue hover:text-light">
      ...
      <a href="/inquiry"
        class="flex items-center gap-5 py-5 px-10 {{ request()->is('inquiry') ? 'bg-light-blue text-primary' : '' }} transition duration-200 ease-in-out hover:bg-dusty-blue hover:text-light">
        <svg class="h-5 w-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <path
      ...
      <form id="logout-form" action="{{ route('logout') }}" method="POST" class="flex items-center gap-5 py-5 px-10 hover:bg-dusty-blue hover:text-light transition duration-200 ease-in-out">
          @csrf
          <button type="submit" class="flex items-center gap-5 bg-transparent border-0 p-0 m-0 cursor-pointer hover:text-light">
              <svg class="h-5 w-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
